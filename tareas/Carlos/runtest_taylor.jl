...
@testset "pruebas realizadas" begin
    @test taylor(1,[1])+taylor(2,[1,2])==Taylor(1,[2,2]) #sumas
    @test taylor(2,[1,1])+taylor(2,[1,1])==Taylor(1,[2,2])
    @test taylor(1,[1])-taylor(2,[1,2])==Taylor(1,[0,-2])#restas
    @test taylor(2,[1,1])-taylor(2,[1,1])==Taylor(1,[0,0])
